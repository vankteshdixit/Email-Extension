package com.email.email.writer.app;
...
//    private EmailGeneratorService(WebClient webClient){
...
//        extract response and return response
            ...
            return "Error calling Gemini API: " + e.getClass().getSimpleName() + " - " + e.getMessage();
        }
    }
